...
func mm_cvtsd_si64*(a: M128d): int64 {.importc: "_mm_cvtsd_f64".}
...
func mm_cvtsi32_sd*(a: M128d, b: int32): M128d {.importc: "_mm_cvtsi128_si64".}

func mm_cvtsi32_si128*(a: int32): M128i {.importc: "_mm_cvtsi128_si64x".}
